...
XAML_STR = u"""<Window
    ...
    <Grid Margin="12">
        ...
        <!-- Title Bar -->
        <Border Grid.Row="0" Background="#375D6D" Padding="10" CornerRadius="3">
        ...
        <GroupBox Grid.Row="4" Header="Wall Type Filter" Padding="5"
            ...
            <Grid>
                ...
                <TextBlock Grid.Row="0" Text="Select wall types to process:"
                           Foreground="#666666" FontWeight="Normal"
        ...
        <StackPanel Grid.Row="10" Orientation="Horizontal"
            ...
            <Button x:Name="UI_btn_place" Content="Place"
                    ...
                    Background="#375D6D" Foreground="#FFFFFF"
                    FontWeight="SemiBold"/>
