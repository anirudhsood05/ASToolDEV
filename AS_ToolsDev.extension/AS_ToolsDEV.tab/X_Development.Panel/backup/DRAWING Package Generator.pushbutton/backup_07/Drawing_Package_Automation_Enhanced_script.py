...
class DrawingPackageAutomation:
    ...
    def run(self):
        ...
        try:
            ...
            # Transaction 4: Filter Legends (optional)
            if self.generate_filter_legends:
                with revit.Transaction("Drawing Package - Filter Legends"):
    ...
    def step10_generate_filter_legends(self):
        ...
        try:
            ...
            # ================================================================
            # KEY CHANGE: Use only the FIRST view to generate ONE legend
            # ================================================================
            ...
            created_legends = generate_filter_legends(
                self.doc,
                [representative_view],  # ✅ Pass single view in list
                text_type
            )
            ...
            import traceback
            self.output.print_html("<pre>{}</pre>".format(traceback.format_exc()))
            return True  # Non-critical failure - don't abort entire package
