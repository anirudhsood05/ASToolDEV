...
======================================================
Simplified two-column legend: Cut Pattern | Value
Shows only cut fill patterns (ignores projection patterns)
...
class LegendConfig:
    ...
    V_SPACING_MM = 15.0            # Vertical spacing between filter entries
...
def generate_filter_legends(doc, views_with_filters, text_type=None, 
    ...
    """
    Generate simplified two-column legends: Cut Pattern | Value
    Shows only cut fill patterns (projection patterns ignored)
    ...
    Args:
        ...
        region_height_mm: Height of filled regions in mm (default from config)
    ...
    for view in views_with_filters:
        ...
        create_text_note(doc, legend_view, pattern_col_x, current_y, 'Cut Pattern', text_type)
